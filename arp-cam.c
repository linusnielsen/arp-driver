/******************************************************************************
 *
 *   Copyright (C) 2017-2018 Pelagicore AB. All rights reserved.
 *
...
/* Export symbol to make modprobe see the arp-core dependency */
static int arp_cam_dep;
EXPORT_SYMBOL(arp_cam_dep);
